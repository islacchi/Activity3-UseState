    ...
    <View style={{ flex: 1, alignItems: 'center', height:'100%' }}>
      ...
      {showFlashlight && (
        <View style={{width:'320px'}}>
          ...
          {showImage1 ? (
          <Image
          source={{ uri: 'https://icons.veryicon.com/png/o/miscellaneous/official-icon-of-flying-pig/flashlight-off-2.png' }} // Default
            style={{ width: 320, height: 320, marginBottom:'50px' }}
          />
          ) : (
          <Image
          source={{ uri: 'https://icons.veryicon.com/png/o/miscellaneous/official-icon-of-flying-pig/flashlight-on.png' }} // Switch
            style={{ width: 320, height: 320, marginBottom:'50px' }}
          />
          )}
          {isToggled ? (
